import ADD_STORY_IMG from '../assets/images/logos.png';
...
export const getEmptyCardMessage = (filerType) => {
    switch (filerType){
        case "search":
        ...
        default:
            return `Start creating your first Travel Story! Click the 'Add'  button to join 
